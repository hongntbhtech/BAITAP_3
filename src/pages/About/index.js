            ...
            <div className="max-w-screen-2xl font-poppins">
                ...
                <div className="w-[79.2%] mx-auto pt-[117px] max-h-[976px]">
                    <div className="max-w-[732px]">
                        ...
                        <h1 className="font-semibold text-[36px] text-[#091156] leading-[45px] pt-[12px] -tracking-[0.1px]">We are a leading beauty clinic that has been around since 2002</h1>
