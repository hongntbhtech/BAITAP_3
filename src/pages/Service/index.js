        ...
        <>
                ...
                <div className="max-w-[1100px] mx-auto pt-[118px]">
                    <div className="text-center">
                        <h4 className="font-semibold text-[16px] text-[#FF64AE] leading-[20px]">Our Services</h4>
                        <h1 className="font-semibold text-[36px] text-[#091156] leading-[45px] pt-[11px] -tracking-[0.1px]">We focus on your beauty</h1>
                        <p className="font-normal text-[16px] text-[#8B8B8B] leading-[24px] tracking-[1.6px] pt-[24px]">Lorem ipsum dolor sit amet</p>
                    </div>

                    <div className="flex justify-between pt-[74px]">
                        <img src={img_service1} alt="abc"></img>
                        <img src={img_service2} alt="abc"></img> 
                    </div>

                    <div className="flex justify-between pt-[68px]">
                        <img src={img_service3} alt="abc"></img>
                        <img src={img_service4} alt="abc"></img> 
                    </div>
                </div>
                ...
                <div className='flex mx-auto max-w-[1137px] justify-between pt-[141px]'>
                    ...
                    <div className='max-w-[475px] pt-[29px]'>
                        ...
                        <p className='text-[16px] font-normal leading-[24px] tracking-[1.6px] text-[#8b8b8b] max-w-[480px] pt-[12px] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elit, quam suscipit purus donec amet. Egestas volutpat facilisi eu libero.</p>
                        <div className="flex">
                        <p className="text-[16px] font-semibold leading-[24px] tracking-[1.5px] text-[#091156] max-w-[480px] pt-[25px] "> Make an Appointment</p>
                ...
                <div className='h-[529px]' style={{ backgroundImage: `url(${bg_service1})` }}>
                    <div className="max-w-[1140px] mx-auto flex justify-between pt-[183px]">
                        <div className="max-w-[732px]">
                            <h1 className="font-semibold text-[36px] leading-[45px] text-[#ffffff] max-w-[570px] -tracking-[0.3px]">Best responsibility and service for our customers</h1>
                            <p className="font-normal text-[16px] leading-[24px] text-[#CACACA] tracking-[1.6px] max-w-[570px] pt-[18px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis</p>
                        </div>

                        <div className="flex max-w-[500px] pr-[58px] justify-between">
                            <img className="" src={play_button} alt="abc"></img>
                            <p className="ml-[9px] font-semibold text-[16px] leading-[24px] tracking-[1.6px] text-[#ffffff] pt-[66px]">Treatments Videos</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-[972px] mx-auto pt-[117px] pb-[31px]">
                    ...
                    <div className="w-[972px] h-[1px] bg-[#091156]">
