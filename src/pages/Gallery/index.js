            ...
            <div className="max-w-screen-2xl font-poppins">
                ...
                <div className="max-w-[1140px] flex justify-between mx-auto pt-[122px] pb-[30px]">
                    <div className="max-w-[642px]">
                        ...
                        <p className="font-normal text-[16px] leading-[24px] tracking-[1.6px] max-w-[561px] pt-[22px]">Id dui erat sed quam tellus in purus. Pellentesque congue fringilla cras tellus enim.</p>
                    </div>
